...
std::function<std::vector<double>(const std::string&)> Parsers::doubleArrayParser = Parsers::arrayDecorator<double>(Parsers::doubleParser);
std::function<std::vector<int>(const std::string&)> Parsers::integerArrayParser = Parsers::arrayDecorator<int>(Parsers::integerParser);
